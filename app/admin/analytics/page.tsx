...
const visitorData = [
  { name: 'Mon', visitors: 0 }, { name: 'Tue', visitors: 0 },
  { name: 'Wed', visitors: 0 }, { name: 'Thu', visitors: 0 },
  { name: 'Fri', visitors: 0 }, { name: 'Sat', visitors: 0 },
  { name: 'Sun', visitors: 0 },
];

const trafficSources = [
  { name: 'Search', value: 0 }, { name: 'Direct', value: 0 },
  { name: 'Social', value: 0 }, { name: 'Referral', value: 0 },
];
  ...
  return (
    <div className="space-y-6 animate-fade-in pb-10">
      <div className="flex justify-between items-center">
        ...
        <select className="bg-white dark:bg-[#1e293b] border border-gray-200 dark:border-gray-700 px-4 py-2 rounded-xl text-sm font-bold text-gray-700 dark:text-gray-300 outline-none shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white dark:bg-[#1e293b] p-6 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-800">
          ...
          <h3 className="text-3xl font-black text-gray-900 dark:text-white">0s</h3>
          <p className="text-xs font-bold text-gray-500 mt-2 flex items-center gap-1">No data available</p>
        </div>
        <div className="bg-white dark:bg-[#1e293b] p-6 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-800">
          <div className="flex items-center gap-3 mb-2">
          ...
          <div className="bg-white dark:bg-[#1e293b] p-6 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-800">
            ...
            <div className="flex justify-around items-end h-24">
              <div className="flex flex-col items-center gap-2">
                <div className="h-1 w-8 bg-blue-500 rounded-t-lg relative group"><span className="absolute -top-6 left-1/2 -translate-x-1/2 text-xs font-bold opacity-0 group-hover:opacity-100 transition-opacity text-gray-900 dark:text-white">0%</span></div>
                <Smartphone className="w-5 h-5 text-gray-500" />
              </div>
              <div className="flex flex-col items-center gap-2">
                <div className="h-1 w-8 bg-green-500 rounded-t-lg relative group"><span className="absolute -top-6 left-1/2 -translate-x-1/2 text-xs font-bold opacity-0 group-hover:opacity-100 transition-opacity text-gray-900 dark:text-white">0%</span></div>
                <Monitor className="w-5 h-5 text-gray-500" />
              </div>
              <div className="flex flex-col items-center gap-2">
                <div className="h-1 w-8 bg-purple-500 rounded-t-lg relative group"><span className="absolute -top-6 left-1/2 -translate-x-1/2 text-xs font-bold opacity-0 group-hover:opacity-100 transition-opacity text-gray-900 dark:text-white">0%</span></div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center max-w-4xl mx-auto gap-4">
          <div className="text-center w-full md:w-auto">
            <div className="w-24 h-24 mx-auto rounded-full bg-gray-100 dark:bg-[#0f172a] border-4 border-gray-200 dark:border-gray-700 flex items-center justify-center mb-3">
              <span className="text-xl font-black text-gray-900 dark:text-white">0</span>
            </div>
          ...
          <div className="text-center w-full md:w-auto">
            ...
            <p className="text-xs text-gray-400 font-bold mt-1">0% Drop-off</p>
          </div>
          <ArrowRight className="w-6 h-6 text-gray-300 dark:text-gray-700 hidden md:block rotate-90 md:rotate-0" />
          <div className="text-center w-full md:w-auto">
            <div className="w-24 h-24 mx-auto rounded-full bg-gray-100 dark:bg-[#0f172a] border-4 border-gray-200 dark:border-gray-700 flex items-center justify-center mb-3">
          ...
          <div className="text-center w-full md:w-auto">
            ...
            <p className="text-xs text-gray-400 font-bold mt-1">0% Conversion Rate</p>
          </div>
        </div>
      </div>
    </div>
