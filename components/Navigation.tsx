    ...
    <nav className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? 'bg-white/80 dark:bg-gray-900/80 backdrop-blur-md shadow-md py-3' : 'bg-transparent py-5'}`}>
      <div className="container mx-auto px-4 flex justify-between items-center">
        <Link href="/" className="flex items-center gap-2 group">
          <div className="w-14 h-14 relative group-hover:scale-105 transition-transform rounded-full overflow-hidden shadow-md border border-[var(--color-saffron)]">
            <Image src="/logoKrishna.png" alt="Vishram Sthal Logo" fill sizes="56px" className="object-cover" priority quality={100} unoptimized />
          </div>
